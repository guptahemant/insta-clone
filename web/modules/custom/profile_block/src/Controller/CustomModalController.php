...
class CustomModalController extends ControllerBase{
  ...
  { 
    ...
    foreach ($fuid as $row) {
      ...
      //for followers count
      // $query3 = $this->connection->select('flag_counts', 'f');
  ...
  public function unfollow(){
    ...
    // $query11 = $this->connection->update('flag_counts')->fields(['counts' => '5'])->condition('entity_id', $uid)->execute();
    ...
    // $response="hello";
    // $a = new following_modal();
    // return $this->following_modal(); 
    ...
    // ];
    // $response = new AjaxResponse();
    // $response->addCommand(new OpenModalDialogCommand($this->following_modal()));
    // return $response;
  }
