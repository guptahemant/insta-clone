 ...
 * @endcode
 */
$settings['hash_salt'] = 'EvIWmDTCF4dqnki8tPJ3AUv_7gDi--eB_oBhrkKnRx4aVrZ03mQ4NG4Cf4lK_n4iIfZUFF72MQ';
...
$settings['config_sync_directory'] = 'sites/default/files/config_g-yDCHLPrzLp_9RTfGvo1M154Nf25Vcog5Ga0kid7j4MYWCnxWueMjGbVBnOoVFk-BmJfavVsg/sync';

if (file_exists($app_root . '/' . $site_path . '/web/sites/default/settings.local.php')) {
  include $app_root . '/' . $site_path . '/web/sites/default/settings.local.php';
}
